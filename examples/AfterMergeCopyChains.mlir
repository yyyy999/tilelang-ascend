...
module attributes {hivm.module_core_type = #hivm.module_core_type<AIC>, memref.memref_as_ptr} {
  func.func @flash_attention(%arg0: i64 {hacc.arg_type = #hacc.arg_type<ffts_base_address>}, %arg1: memref<?xi8, #hivm.address_space<gm>>, %arg2: memref<?xi8, #hivm.address_space<gm>> {hacc.arg_type = #hacc.arg_type<workspace>}, %arg3: memref<?xf16, #hivm.address_space<gm>>, %arg4: memref<?xf16, #hivm.address_space<gm>>, %arg5: memref<?xf16, #hivm.address_space<gm>>, %arg6: memref<?xf16, #hivm.address_space<gm>>, %arg7: i32, %arg8: i32, %arg9: i32, %arg10: i32, %arg11: i32, %arg12: i32) attributes {SyncBlockLockArgIdx = 0 : i64, WorkspaceArgIdx = 1 : i64, hacc.entry, hacc.function_kind = #hacc.function_kind<DEVICE>, hivm.func_core_type = #hivm.func_core_type<AIC>, mix_mode = "aic"} {
    ...
    %4 = memref_ext.alloc_workspace() : memref<2x64x256xf32, #hivm.address_space<gm>>
    annotation.mark %4 {hivm.multi_buffer = 2 : i32} : memref<2x64x256xf32, #hivm.address_space<gm>>
    %5 = memref_ext.alloc_workspace() : memref<2x64x256xf16, #hivm.address_space<gm>>
    annotation.mark %5 {hivm.multi_buffer = 2 : i32} : memref<2x64x256xf16, #hivm.address_space<gm>>
    %6 = memref_ext.alloc_workspace() : memref<2x64x128xf32, #hivm.address_space<gm>>
    annotation.mark %6 {hivm.multi_buffer = 2 : i32} : memref<2x64x128xf32, #hivm.address_space<gm>>
    ...
    scf.for %arg13 = %c0_i32 to %8 step %c1_i32  : i32 {
      ...
      scf.for %arg14 = %c0_i32 to %c32_i32 step %c1_i32  : i32 {
        ...
        annotation.mark %alloc_12 {hivm.multi_buffer = 2 : i32} : memref<32x1xf32, strided<[1, 1]>, #hivm.address_space<ub>>
        ...
        scope.scope : () -> () {
          ...
          memref.copy %subview_15, %alloc_13 : memref<256x128xf16, strided<[128, 1], offset: ?>, #hivm.address_space<gm>> to memref<256x128xf16, strided<[128, 1]>, #hivm.address_space<cbuf>>
          ...
          %subview_16 = memref.subview %4[0, 0, 0] [1, 64, 256] [1, 1, 1] : memref<2x64x256xf32, #hivm.address_space<gm>> to memref<64x256xf32, strided<[256, 1]>, #hivm.address_space<gm>>
          memref.copy %alloc_14, %subview_16 : memref<64x256xf32, strided<[256, 1]>, #hivm.address_space<cc>> to memref<64x256xf32, strided<[256, 1]>, #hivm.address_space<gm>>
          scope.return
        ...
        scope.scope : () -> () {
          ...
          %subview_20 = memref.subview %4[0, %24, 0] [1, 32, 256] [1, 1, 1] : memref<2x64x256xf32, #hivm.address_space<gm>> to memref<32x256xf32, strided<[256, 1], offset: ?>, #hivm.address_space<gm>>
          memref.copy %subview_20, %alloc_13 : memref<32x256xf32, strided<[256, 1], offset: ?>, #hivm.address_space<gm>> to memref<32x256xf32, strided<[256, 1]>, #hivm.address_space<ub>>
          ...
          hivm.hir.vexp ins(%alloc_19 : memref<32x1xf32, strided<[1, 1]>, #hivm.address_space<ub>>) outs(%alloc_12 : memref<32x1xf32, strided<[1, 1]>, #hivm.address_space<ub>>)
          ...
          %subview_21 = memref.subview %5[0, %24, 0] [1, 32, 256] [1, 1, 1] : memref<2x64x256xf16, #hivm.address_space<gm>> to memref<32x256xf16, strided<[256, 1], offset: ?>, #hivm.address_space<gm>>
          memref.copy %alloc_14, %subview_21 : memref<32x256xf16, strided<[256, 1]>, #hivm.address_space<ub>> to memref<32x256xf16, strided<[256, 1], offset: ?>, #hivm.address_space<gm>>
          scope.return
        ...
        scope.scope : () -> () {
          ...
          %subview_16 = memref.subview %5[0, 0, 0] [1, 64, 256] [1, 1, 1] : memref<2x64x256xf16, #hivm.address_space<gm>> to memref<64x256xf16, strided<[256, 1]>, #hivm.address_space<gm>>
          memref.copy %subview_16, %alloc_14 : memref<64x256xf16, strided<[256, 1]>, #hivm.address_space<gm>> to memref<64x256xf16, strided<[256, 1]>, #hivm.address_space<cbuf>>
          ...
          memref.copy %subview_17, %alloc_13 : memref<256x128xf16, strided<[128, 1], offset: ?>, #hivm.address_space<gm>> to memref<256x128xf16, strided<[128, 1]>, #hivm.address_space<cbuf>>
          ...
          %subview_18 = memref.subview %6[0, 0, 0] [1, 64, 128] [1, 1, 1] : memref<2x64x128xf32, #hivm.address_space<gm>> to memref<64x128xf32, strided<[128, 1]>, #hivm.address_space<gm>>
          memref.copy %alloc_15, %subview_18 : memref<64x128xf32, strided<[128, 1]>, #hivm.address_space<cc>> to memref<64x128xf32, strided<[128, 1]>, #hivm.address_space<gm>>
          scope.return
        } {hivm.tcore_type = #hivm.tcore_type<CUBE>}
        scope.scope : () -> () {
          %alloc_13 = memref.alloc() : memref<32x128xf32, strided<[128, 1]>, #hivm.address_space<ub>>
          %subview_14 = memref.subview %6[0, %24, 0] [1, 32, 128] [1, 1, 1] : memref<2x64x128xf32, #hivm.address_space<gm>> to memref<32x128xf32, strided<[128, 1], offset: ?>, #hivm.address_space<gm>>
          memref.copy %subview_14, %alloc_13 : memref<32x128xf32, strided<[128, 1], offset: ?>, #hivm.address_space<gm>> to memref<32x128xf32, strided<[128, 1]>, #hivm.address_space<ub>>
      ...
      %subview_10 = memref.subview %alloc_9[0, 0] [%18, 128] [1, 1] : memref<32x128xf16, strided<[128, 1]>, #hivm.address_space<ub>> to memref<?x128xf16, strided<[128, 1]>, #hivm.address_space<ub>>
