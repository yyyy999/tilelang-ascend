    ...
    scf.for %arg13 = %c0_i32 to %8 step %c1_i32  : i32 {
      ...
      scf.for %arg14 = %c0_i32 to %13 step %c1_i32  : i32 {
        ...
        scf.for %arg15 = %c0_i32_16 to %c4_i32_17 step %c1_i32_18  : i32 {
          ...
          %subview_36 = memref.subview %alloc_12[%30, 0, 0] [1, 32, 1] [1, 1, 1] : memref<4x32x1xf32, strided<[32, 1, 1]>, #hivm.address_space<ub>> to memref<1x32x1xf32, strided<[32, 1, 1], offset: ?>, #hivm.address_space<ub>>
          %collapse_shape_37 = memref.collapse_shape %subview_36 [[0, 1], [2]] : memref<1x32x1xf32, strided<[32, 1, 1], offset: ?>, #hivm.address_space<ub>> into memref<32x1xf32, strided<[1, 1], offset: ?>, #hivm.address_space<ub>>
          hivm.hir.vexp ins(%alloc_35 : memref<32x1xf32, strided<[1, 1]>, #hivm.address_space<ub>>) outs(%collapse_shape_37 : memref<32x1xf32, strided<[1, 1], offset: ?>, #hivm.address_space<ub>>)
          ...
          %subview_38 = memref.subview %alloc_12[%31, 0, 0] [1, 32, 1] [1, 1, 1] : memref<4x32x1xf32, strided<[32, 1, 1]>, #hivm.address_space<ub>> to memref<1x32x1xf32, strided<[32, 1, 1], offset: ?>, #hivm.address_space<ub>>
          %collapse_shape_39 = memref.collapse_shape %subview_38 [[0, 1], [2]] : memref<1x32x1xf32, strided<[32, 1, 1], offset: ?>, #hivm.address_space<ub>> into memref<32x1xf32, strided<[1, 1], offset: ?>, #hivm.address_space<ub>>
          hivm.hir.vmul ins(%alloc_6, %collapse_shape_39 : memref<32x1xf32, strided<[1, 1]>, #hivm.address_space<ub>>, memref<32x1xf32, strided<[1, 1], offset: ?>, #hivm.address_space<ub>>) outs(%alloc_6 : memref<32x1xf32, strided<[1, 1]>, #hivm.address_space<ub>>)
        ...
        scf.for %arg15 = %c0_i32_22 to %c4_i32_23 step %c1_i32_24  : i32 {
          ...
          %30 = arith.index_cast %arg15 : i32 to index
          %subview_28 = memref.subview %alloc_12[%30, 0, 0] [1, 32, 1] [1, 1, 1] : memref<4x32x1xf32, strided<[32, 1, 1]>, #hivm.address_space<ub>> to memref<1x32x1xf32, strided<[32, 1, 1], offset: ?>, #hivm.address_space<ub>>
          %collapse_shape_29 = memref.collapse_shape %subview_28 [[0, 1], [2]] : memref<1x32x1xf32, strided<[32, 1, 1], offset: ?>, #hivm.address_space<ub>> into memref<32x1xf32, strided<[1, 1], offset: ?>, #hivm.address_space<ub>>
          hivm.hir.vmul ins(%alloc_7, %collapse_shape_29 : memref<32x128xf32, strided<[128, 1]>, #hivm.address_space<ub>>, memref<32x1xf32, strided<[1, 1], offset: ?>, #hivm.address_space<ub>>) outs(%alloc_7 : memref<32x128xf32, strided<[128, 1]>, #hivm.address_space<ub>>) broadcast = [1]
